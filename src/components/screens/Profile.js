...
const Profile = () => {
  ...
  /*Cambia el estado del Switch cuando es presionado */
  const toggleSwitch = () => {
  ...
  /*Cierra la sesión actual por medio de firebase */
  const SignOut = () => {
    signout();
  };
      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.header}>
            ...
            >
              Esperamos que tu estadia en esta app sea de tu agrado. Recuerda
              que no cualquiera puede cocinar pero si de cualquier lugar puede
              surgir un gran chef.
            </Text>
