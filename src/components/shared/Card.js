          ...
          <>
            <TouchableOpacity
              ...
              style={
                state.darkMode === "light"
                  ? [styles.card, { backgroundColor: "#b580ba", shadowColor: "black"}]
                  : [styles.card, { backgroundColor: "#00000099", shadowColor: "black"}]
              }
              onPress={() => {
            ...
            >
              ...
              <View
                style={
                  state.darkMode === "light"
                    ? [styles.ContTitle, { backgroundColor: "#24507198", shadowColor: "black"}]
                    : [styles.ContTitle, { backgroundColor: "#B4975A", shadowColor: "#B4975A"}]
                }
              >
                <Text
                  style={
